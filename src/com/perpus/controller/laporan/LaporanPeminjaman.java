package com.perpus.controller.laporan;
...
public class LaporanPeminjaman extends javax.swing.JPanel {
    ...
    try {
        ...
        try (PreparedStatement st = conn.prepareStatement(sql)) {
            st.setString(1, dateFormat.format(this.tanggalMulai));
            st.setString(2, dateFormat.format(this.tanggalAkhir));
        ...
        JOptionPane.showMessageDialog(this, "Terjadi kesalahan saat menghitung total data!", "Error", JOptionPane.ERROR_MESSAGE);
    }
    ...
    if (tanggalMulai.isEmpty() || tanggalAkhir.isEmpty()) {
        JOptionPane.showMessageDialog(this, "Tanggal mulai dan tanggal akhir harus diisi!", "Error", JOptionPane.ERROR_MESSAGE);
        return;
    }
    ...
    try {
        ...
        String sql = "SELECT "
                    ...
                    + "AND pmj.Tanggal_Peminjaman BETWEEN ? AND ? "
