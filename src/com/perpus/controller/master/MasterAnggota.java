...
public class MasterAnggota extends javax.swing.JPanel {
    ...
    try {
        String sql = "SELECT * FROM anggota LIMIT ? OFFSET ?";
        try (PreparedStatement st = conn.prepareStatement(sql)) {
    ...
    try {
        ...
        try(PreparedStatement st = conn.prepareStatement(sql)){
            ...
            st.setString(6, tanggalBergabung); // Format tanggal sebagai TEXT
    ...
    try {
        ...
        try(PreparedStatement st = conn.prepareStatement(sql)){
            ...
            st.setString(5, tanggalBergabung); // Format tanggal sebagai TEXT
