...
import com.perpus.view.form.FormLogin;
...
public class MasterPetugas extends javax.swing.JPanel {
    ...
    String password = txtPassword.getText(); // Ambil password langsung dari field
    ...
    try {
        ...
        try(PreparedStatement st = conn.prepareStatement(sql)){
            ...
            st.setString(5, password); // Simpan password langsung
